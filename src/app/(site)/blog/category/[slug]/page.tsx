...
import { getPostsByCategorySlug } from '@/lib/data/getBlog'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${data.category.name} Articles | Airline Office Directory`,
    description: data.category.description || `All blog posts in the ${data.category.name} category.`,
    alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL}/blog/category/${slug}/` },
  }
}
