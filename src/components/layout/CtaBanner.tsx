      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:px-12 sm:py-20 lg:px-8">
        <div className="flex flex-col items-center gap-6 text-center sm:flex-row sm:justify-between sm:text-left">
          ...
          {settings.contactPhone && (
            <a
              href={tel}
              className="inline-flex items-center gap-2 rounded-full bg-orange-600 px-6 py-3 text-sm font-bold text-white shadow-lg hover:bg-orange-700 transition-colors shrink-0"
            >
